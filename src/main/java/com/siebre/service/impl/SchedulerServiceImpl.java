...
import com.siebre.service.SchedulerService;
...
public class SchedulerServiceImpl implements SchedulerService {  
    ...
    public void pauseTrigger(String triggerName, String group) {  
        try {  
            scheduler.pauseTrigger(new TriggerKey(triggerName, group));// Í£Ö¹´¥·¢Æ÷  
        } catch (SchedulerException e) {  
    ...
    public void resumeTrigger(String triggerName, String group) {  
        try {  
            scheduler.resumeTrigger(new TriggerKey(triggerName, group));// ÖØÆô´¥·¢Æ÷  
        } catch (SchedulerException e) {  
            throw new RuntimeException(e);  
        }  
    }  
    ...
    public boolean removeTrigdger(String triggerName, String group) {  
        ...
        try {  
            scheduler.pauseTrigger(triggerKey);// Í£Ö¹´¥·¢Æ÷  
            return scheduler.unscheduleJob(triggerKey);// ÒÆ³ý´¥·¢Æ÷  
        } catch (SchedulerException e) {  
            throw new RuntimeException(e);  
        }  
    }  
